          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            {article.commentsUrl && (
              <a
                ...
                rel="noopener noreferrer"
                onClick={onOpenOriginal}
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-bg-elevated text-text-secondary rounded-lg hover:bg-bg-overlay hover:text-text-primary transition-colors font-medium"
              >
                View Discussion
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
